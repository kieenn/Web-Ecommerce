...
-- Create the Categories table
CREATE TABLE Categories (
  id INT PRIMARY KEY IDENTITY(1,1),  -- Automatically manage id
  name NVARCHAR(255),
...
CREATE TABLE Product_Attributes_Values (
    id INT PRIMARY KEY IDENTITY(1,1),
    products_sku_id NVARCHAR(255),
    product_attribute_id INT,
    value NVARCHAR(255),
    CONSTRAINT FK_Product_Attributes_Values_Products_SKUs FOREIGN KEY (products_sku_id) REFERENCES Products_SKUs(sku),
...
CREATE TABLE Cart_Item (
  ...
  CONSTRAINT FK_Cart_Item_Cart FOREIGN KEY (cart_id) REFERENCES Cart(id),
  CONSTRAINT FK_Cart_Item_Products FOREIGN KEY (product_id) REFERENCES Products(id),
  CONSTRAINT FK_Cart_Item_Products_SKUs FOREIGN KEY (products_sku_id) REFERENCES Products_SKUs(sku)
);
...
CREATE TABLE Order_Item (
  ...
  CONSTRAINT FK_Order_Item_Order_Details FOREIGN KEY (order_id) REFERENCES Order_Details(id),
  CONSTRAINT FK_Order_Item_Products FOREIGN KEY (product_id) REFERENCES Products(id),
  CONSTRAINT FK_Order_Item_Products_SKUs FOREIGN KEY (products_sku_id) REFERENCES Products_SKUs(sku)
);
